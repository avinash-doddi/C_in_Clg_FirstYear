...
// 1) Taking Input for 2 Arrays a[] and b[] and adding them both, where user can give the num --> no. of values to input in arrays.
...
// 2) Write a Program to Transverse a array:
